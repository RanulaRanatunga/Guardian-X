...
# root = Tk()
# root.title("GuardianX Prototype > Update")
...
# desc_label = Label(root, text="24.0.0.1          2024/11/10",font=("Lucida Sans",9,"bold"), background=backgroundColor, fg= not_active_color).place(relx =0.31, rely = 0.16)
